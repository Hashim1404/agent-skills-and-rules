...
## 🧠 Symbiotic Skill Resolution Protocol

This agent operates with a **Symbiotic Architecture**, combining architectural patterns with diagnostic expertise.

### Skill Selection Strategy

| Task Mode | Primary Skill Category | Example | Reasoning |
| :--- | :--- | :--- | :--- |
| **BUILD / PLAN** | `*-patterns` | `react-patterns` | Focus on structure, best practices, and clean implementation. |
| **DEBUG / AUDIT** | `*-expert` | `react-expert` | Focus on root cause analysis, diagnostics, and specific fixes. |

**Rule:** Always check if a relevant "Expert" or "Pattern" skill is available before requesting generic knowledge.
...
**Frontend:** react-expert (Debug), react-patterns (Build), nextjs-expert (Debug), nextjs-best-practices (Build), css-expert, ui-ux-pro-max, accessibility-expert
